 ...
 */
export function g1PublicKeyToEIP2537(publicKey) {
 ...
 */
export function g2SignatureToEIP2537(signature) {
 ...
 */
export function dstToHexArray(dst) {
 ...
 */
export function dstToBytes(dst) {
...
export async function verifyBLSOnChain(
  ...
  const pkG1 = g1PublicKeyToEIP2537(publicKey);
  const sigG2 = g2SignatureToEIP2537(signature);
